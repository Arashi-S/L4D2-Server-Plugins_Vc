...
public void OnPluginStart()
{
	...
	g_hItemCvarColor		= CreateConVar("l4d2_item_hint_glow_color", "0 255 127", "物品发光颜色 (无内容 = 关闭发光)", FCVAR_NOTIFY);
	g_hItemInstructorHint	= CreateConVar("l4d2_item_instructorhint_enable", "1", "在物品上方显示物品提示 (0:禁用, 1启用)", FCVAR_NOTIFY, true, 0.0, true, 1.0);
	g_hItemInstructorColor	= CreateConVar("l4d2_item_instructorhint_color", "255 174 185", "物品上方提示的颜色", FCVAR_NOTIFY);
	...
	g_hSpotMarkCoolDown			= CreateConVar("l4d2_spot_marker_cooldown_time", "2.0", "玩家使用语音菜单“Z”键的“看”创建标记的冷却时间", FCVAR_NOTIFY, true, 0.0);
	...
	g_hSpotMarkAnnounceType		= CreateConVar("l4d2_spot_marker_announce_type", "2", "标记提示的方式 (0:禁用, 1:聊天框, 2:弹出提示, 3:屏幕中心)", FCVAR_NOTIFY, true, 0.0, true, 3.0);
	g_hSpotMarkGlowTimer		= CreateConVar("l4d2_spot_marker_duration", "10.0", "标记持续时间", FCVAR_NOTIFY, true, 0.0);
	g_hSpotMarkCvarColor		= CreateConVar("l4d2_spot_marker_color", "160 32 240", "标记颜色 (无内容 = 关闭颜色)", FCVAR_NOTIFY);
	...
	g_hSpotMarkInstructorColor	= CreateConVar("l4d2_spot_marker_instructorhint_color", "255 174 185", "标记上方提示的颜色", FCVAR_NOTIFY);
	g_hSpotMarkInstructorIcon	= CreateConVar("l4d2_spot_marker_instructorhint_icon", "icon_alert_red", "标记上方提示图标", FCVAR_NOTIFY);
	...
	g_hInfectedMarkUseSound		= CreateConVar("l4d2_infected_marker_use_sound", "", "标记特殊感染者的提示音 (格式一般是:“sound/”, 无内容:禁用)", FCVAR_NOTIFY);
	...
	g_hInfectedMarkCvarColor   	= CreateConVar("l4d2_infected_marker_glow_color", "255 250 240", "特殊感染者标记颜色 （无内容=禁用特殊感染者发光）", FCVAR_NOTIFY);
