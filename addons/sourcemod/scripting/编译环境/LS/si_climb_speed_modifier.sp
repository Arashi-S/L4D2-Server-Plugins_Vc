...
public void OnPluginStart() {
	...
	g_cvAIClimbSpeed = CreateConVar("l4d2_ai_climb_speed", "223", "AI特感爬升速度", FCVAR_NOTIFY, true, 0.0);
	g_cvPZClimbSpeed = CreateConVar("l4d2_pz_climb_speed", "223", "玩家特感爬升速度", FCVAR_NOTIFY, true, 0.0);
