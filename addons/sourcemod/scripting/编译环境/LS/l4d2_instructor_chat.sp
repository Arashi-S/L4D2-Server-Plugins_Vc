...
public void OnPluginStart() {
	...
	cIcon =		CreateConVar(PLUGIN_NAME ... "_icon", "icon_info",		"图标样式 ./pak01_dir.vpk/scripts/mod_textures.txt", FCVAR_NOTIFY);
	cColor =	CreateConVar(PLUGIN_NAME ... "_color", "255,174,185",	"讲师提示颜色，RGB 格式", FCVAR_NOTIFY);
