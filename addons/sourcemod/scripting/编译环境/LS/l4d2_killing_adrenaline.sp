...
public void OnPluginStart() {
	...
	Adrenaline_allow_cooling =	CreateConVar("killing_adrenaline_allow_cooling", "0", "allow increase duration even player not under adrenaline", FCVAR_NOTIFY, true, 0.0);
