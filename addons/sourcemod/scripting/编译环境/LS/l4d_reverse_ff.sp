...
public void OnPluginStart()
{
	...
	cvar_reverseff_infectedmaxdmg = CreateConVar("reverseff_infectedmaxdmg", "0", "Maximum damage allowed before kick/ban infected (0=disable)", CVAR_FLAGS);
	cvar_reverseff_tankmaxdmg = CreateConVar("reverseff_tankmaxdmg", "0", "Maximum damage allowed before kick/ban tank (0=disable)", CVAR_FLAGS);
	cvar_reverseff_cooldowntime = CreateConVar("reverseff_cooldowntime", "0", "Cool down time in seconds (0=disable)", CVAR_FLAGS);
	cvar_reverseff_banduration = CreateConVar("reverseff_banduration", "-1", "Ban duration in minutes (0=permanent ban, -1=kick instead of ban)", CVAR_FLAGS);
	cvar_reverseff_proximity = CreateConVar("reverseff_proximity", "50", "Attacker/victim distance to prevent ReverseFF (0=disable)", CVAR_FLAGS);
	...
	cvar_reverseff_announce = CreateConVar("reverseff_announce", "0", "0=Do not announce plugin, 1=Announce plugin", CVAR_FLAGS);
	cvar_reverseff_chatmsg = CreateConVar("reverseff_chatmsg", "0", "0=Do not display ReverseFF chat messages, 1=Display ReverseFFchat messages", CVAR_FLAGS);
