...
public void OnPluginStart()
{
	...
	hCvarPillTotal =		CreateConVar("l4d_pills_hot_total",			"75",	"Total amount for pills hot",		FCVAR_NOTIFY|FCVAR_SPONLY, true, 0.0);
	...
	hCvarAdrenTotal =		CreateConVar("l4d_adrenaline_hot_total",		"25",	"Total amount for adrenaline hot",		FCVAR_NOTIFY|FCVAR_SPONLY, true, 0.0);
