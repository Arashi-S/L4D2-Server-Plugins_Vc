...
{
	// 添加几个Cvar
	g_AmmoFillClip = CreateConVar ("ss_ammoclip", "30", "杀多少小ss回复一个弹夹的子弹, 0 = 关闭此功能, >0 = Cvar数值", FCVAR_NOTIFY, true, 0.0);
	...
	g_HealthRegain = CreateConVar ("ss_healthregain", "0", "杀上面数量特殊感染者回复多少实血", FCVAR_NOTIFY, true, 0.0);
