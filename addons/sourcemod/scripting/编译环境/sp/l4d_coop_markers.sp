...
public void OnPluginStart()
{
	...
	if( !g_bLeft4Dead2 )
		g_hCvarModes =	CreateConVar(	"l4d_coop_markers_modes",			"1",					"Turn on the plugin in these game modes. 0=All, 1=Coop, 2=Survival, 4=Versus. Add numbers together.", CVAR_FLAGS );
	g_hCvarPanel =		CreateConVar(	"l4d_coop_markers_panel",			"1",					"0=Print to chat. 1=Display panel.", CVAR_FLAGS );
	g_hCvarPercent =	CreateConVar(	"l4d_coop_markers_percent",			"10",					"After what percentage of progress to display the marker.", CVAR_FLAGS );
