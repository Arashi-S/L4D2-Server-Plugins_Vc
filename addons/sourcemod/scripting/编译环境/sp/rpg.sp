...
public Action:Timer_AutoGive(Handle:timer,any client) 
{
	...
	{
		BypassAndExecuteCommand(client, "give", "baseball_bat");
	}
	if (player_data[client][MELEE] == 7)
	{
		BypassAndExecuteCommand(client, "give", "cricket_bat");
	}
	if (player_data[client][MELEE] == 8)
	{
		BypassAndExecuteCommand(client, "give", "crowbar");
	}
	if (player_data[client][MELEE] == 9)
	{
		BypassAndExecuteCommand(client, "give", "electric_guitar");
	}
	if (player_data[client][MELEE] == 10)
	{
		BypassAndExecuteCommand(client, "give", "frying_pan");
	}
	if (player_data[client][MELEE] == 11)
	{
		BypassAndExecuteCommand(client, "give", "tonfa");
	}
	if (player_data[client][MELEE] == 12)
	{
		BypassAndExecuteCommand(client, "give", "golfclub");
	}
	if (player_data[client][MELEE] == 13)
	{
		BypassAndExecuteCommand(client, "give", "pitchfork");
	}
	if (player_data[client][MELEE] == 14)
	{
