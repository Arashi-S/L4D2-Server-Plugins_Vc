...
public void OnPluginStart()
{
    ...
    g_hCvar_Enabled       = CreateConVar("l4d2_wskin_rng_enable", "1","是否开启插件.\n0=关闭, 1=开启", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_IgnoreSkin    = CreateConVar("l4d2_wskin_rng_ignore_skin", "1", "忽略已经有不同于默认皮肤的武器\n0=关闭 1=打开", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_PistolMagnum  = CreateConVar("l4d2_wskin_rng_pistol_magnum", "1", "是否开启马格南皮肤\n0=关闭, 1=开启", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_PumpShotgun   = CreateConVar("l4d2_wskin_rng_pump_shotgun", "1", "是否开启木喷皮肤\n0=关闭, 1=开启", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_ShotgunChrome = CreateConVar("l4d2_wskin_rng_shotgun_chrome", "1", "是否开启铁喷皮肤\n0=关闭, 1=开启", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_AutoShotgun   = CreateConVar("l4d2_wskin_rng_auto_shotgun", "1", "是否开启连喷皮肤\n0=关闭, 1=开启", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_SMGUzi        = CreateConVar("l4d2_wskin_rng_smg_uzi", "1", "是否开启冲锋枪皮肤\n0=关闭, 1=开启", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_SMGSilenced   = CreateConVar("l4d2_wskin_rng_smg_silenced", "1", "是否开启消音皮肤\n0=关闭, 1=开启", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_RifleM16      = CreateConVar("l4d2_wskin_rng_rifle_m16", "1", "是否开启M16步枪皮肤\n0=关闭, 1=开启", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_RifleAK47     = CreateConVar("l4d2_wskin_rng_rifle_ak47", "1", "是否开启AK47皮肤\n0=关闭, 1=开启", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_HuntingRifle  = CreateConVar("l4d2_wskin_rng_hunting_rifle", "1", "是否开启木狙皮肤\n0=关闭, 1=开启", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_CricketBat    = CreateConVar("l4d2_wskin_rng_cricket_bat", "1", "是否开启板球棒皮肤\n0=关闭, 1=开启", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_Crowbar       = CreateConVar("l4d2_wskin_rng_crowbar", "1", "是否开启撬棍皮肤\n0=关闭, 1=开启", CVAR_FLAGS, true, 0.0, true, 1.0);
    g_hCvar_Gascan        = CreateConVar("l4d2_wskin_rng_gascan", "1", "是否开启油桶皮肤.\n注意：启用此功能可能会干扰一些插件，这些插件会检查煤气罐外壳，以检测是否为机关类油桶外壳\n0=关闭, 1=开启", CVAR_FLAGS, true, 0.0, true, 1.0);
