...
{
	{"pistol",			"Pistol", 			"99999"},
	{"pistol_magnum",	"Magnum", 			"99999"},
	{"pumpshotgun",		"Pumpshotgun", 		"99999"},
	{"shotgun_chrome",	"Chrome Shotgun", 	"99999"},
	{"smg",				"Smg", 				"99999"},
	{"smg_silenced", 	"Silenced Smg", 	"99999"},
	{"smg_mp5",			"MP5", 				"99999"},
	{"rifle", 			"Rifle", 			"99999"},
	{"rifle_ak47", 		"AK47", 			"99999"},
	{"rifle_desert",	"Desert Rifle", 	"99999"},
	{"rifle_sg552", 	"SG552", 			"99999"},
	{"shotgun_spas",	"Spas Shotgun", 	"99999"},
	{"autoshotgun", 	"Autoshotgun", 		"99999"},
	{"hunting_rifle", 	"Hunting Rifle", 	"99999"},
	{"sniper_military", "Military Sniper", 	"99999"},
	{"sniper_scout", 	"SCOUT", 			"99999"},
	{"sniper_awp", 		"AWP",				"99999"},
	{"rifle_m60", 		"M60 Machine Gun", 	"99999"},
	{"grenade_launcher","Grenade Launcher",	"50"}
};

static char meleeMenu[][][] = 
{
	{"chainsaw",		"Chainsaw", 		"99999"},
	{"baseball_bat",	"Baseball Bat", 	"0"},
	{"cricket_bat", 	"Cricket Bat", 		"0"},
	{"crowbar", 		"Crowbar", 			"0"},
	{"electric_guitar", "Electric Guitar", 	"0"},
	{"fireaxe", 		"Fire Axe", 		"0"},
	{"frying_pan", 		"Frying Pan", 		"0"},
	{"katana", 			"Katana", 			"0"},
	{"machete", 		"Machete", 			"0"},
	{"tonfa", 			"Tonfa", 			"0"},
	{"golfclub", 		"Golf Club", 		"0"},
	{"knife", 			"Knife", 			"0"},
...
{
	{"health_100", 		"Health+100", 		"99999"},
	{"defibrillator",	"Defibrillator", 	"99999"},
	{"first_aid_kit",	"First Aid Kit", 	"99999"},
	{"pain_pills", 		"Pain Pill", 		"99999"},
	{"adrenaline",	 	"Adrenaline", 		"99999"},
	{"pipe_bomb", 		"Pipe Bomb", 		"99999"},
	{"molotov", 		"Molotov", 		"99999"},
	{"vomitjar", 		"Vomitjar", 		"99999"}
};

static char otherMenu[][][] =
{
	{"ammo",		 					"Ammo", 	 			"0"},
	{"laser_sight",						"Laser Sight", 			"99999"},
	{"incendiary_ammo",					"Incendiary Ammo", 		"99999"},
	{"explosive_ammo",					"Explosive Ammo", 		"99999"},
	{"weapon_upgradepack_incendiary",	"Incendiary Pack", 		"99999"},
	{"weapon_upgradepack_explosive",	"Explosive Pack", 		"99999"},
	{"propanetank", 	 				"Propane Tank", 		"99999"},
	{"oxygentank",	 					"Oxygen Tank", 			"99999"},
	{"fireworkcrate",					"Firework Crate", 		"99999"},
	{"gascan",  						"Gascan",				"99999"},
	{"cola_bottles",  					"Cola Bottles",			"99999"},
	{"gnome",							"Gnome", 				"99999"},
};

static char survivorSpecialMenu[][][] =
{
	{"Fire", 			"Fire Yourself", 				"99999"},
	{"Fire_Infeceted", 	"All Infected Gets On Fire", 	"99999"},
	{"Teleport", 		"Teleport to teammate", 		"100"},
	{"Infinite_Ammo",	"Infinite Ammo", 				"100"},
	{"No_FF", 			"No Friendly Fire", 			"100"},
	{"Dead_Eyes",		"Dead-Eyes", 					"200"},
	{"Kill_Commons", 	"Kill Commons", 				"99999"},
	{"Heal_Survivors",	"Heal Survivors", 				"200"},
	{"Jump+1", 			"Jump+1", 						"25"},
	{"Slay_Infected", 	"Slay Infected Attacker", 		"50"},
	{"Kill_Witches", 	"Kill Witches", 				"99999"},
	{"Respawn", 		"Respawn Alive", 				"80"},
	{"Freeze_Infected", "Freeze-Infected", 				"100"},
};
...
static char infectedSpawnMenu[][][] =
{
	...
	{"Boomer",		"Boomer", 			"99999"},
	{"Hunter",		"Hunter", 			"99999"},
	{"Spitter",		"Spitter", 			"99999"},
	{"Jockey",		"Jockey", 			"99999"},
	{"Charger",		"Charger", 			"99999"},
	{"Tank",		"Tank", 			"99999"}
};

static char infectedSpecialMenu[][][] =
{
	{"Health",		"Full Health", 				"250"},
	{"Horde",		"Zombie Horde", 			"1000"},
	{"Witch",		"Witch", 					"1000"},
...
{
	{"weapon_smg",		 				"99999", 	"400"},
	{"weapon_pumpshotgun",				"99999", 	"64"},
	{"weapon_rifle",					"99999", 	"250"},
	{"weapon_autoshotgun",				"99999", 	"64"},
	{"weapon_hunting_rifle",			"99999", 	"100"},
	{"weapon_smg_silenced",				"99999", 	"400"},
	{"weapon_smg_mp5", 	 				"99999", 	"400"},
	{"weapon_shotgun_chrome",	 		"99999", 	"64"},
	{"weapon_rifle_ak47",  				"99999",	"250"},
	{"weapon_rifle_desert",				"99999", 	"250"},
	{"weapon_sniper_military",			"99999", 	"100"},
	{"weapon_grenade_launcher", 	 	"99999", 	"30"},
	{"weapon_rifle_sg552",	 			"99999", 	"250"},
	{"weapon_rifle_m60",  				"99999",	"500"},
	{"weapon_sniper_awp", 	 			"99999", 	"100"},
	{"weapon_sniper_scout",	 			"99999", 	"100"},
	{"weapon_shotgun_spas",  			"99999",	"64"}
...
public void OnPluginStart()
{
	...
	RegConsoleCmd("sm_m", BuyShopCommand);
	...
	//  ConVar //
	//****************//
	g_PlayerRequired = CreateConVar("sm_shop_player_require", "1", "多少真实的感染者和生还者才能激活插件", FCVAR_NOTIFY, true, 1.0);
	g_hCookiesCachedEnable = CreateConVar("sm_shop_CookiesCached_enable", "1", "如果为1则使用CookiesCached储存玩家数据,否则玩家离开服务器数据就莫得了", FCVAR_NOTIFY, true, 0.0, true, 1.0);
	g_BoomerKilled = CreateConVar("sm_shop_boomkilled", "1", "Giving money for killing a boomer", FCVAR_NOTIFY, true, 1.0);
	g_ChargerKilled = CreateConVar("sm_shop_chargerkilled", "12", "Giving money for killing a charger", FCVAR_NOTIFY, true, 1.0);
	g_SmokerKilled = CreateConVar("sm_shop_smokerkilled", "5", "Giving money for killing a smoker", FCVAR_NOTIFY, true, 1.0);
	g_HunterKilled = CreateConVar("sm_shop_hunterkilled", "5", "Giving money for killing a hunter", FCVAR_NOTIFY, true, 1.0);
	g_JockeyKilled = CreateConVar("sm_shop_jockeykilled", "6", "Giving money for killing a jockey", FCVAR_NOTIFY, true, 1.0);
	g_SpitterKilled = CreateConVar("sm_shop_spitterkilled", "2", "Giving money for killing a spitter", FCVAR_NOTIFY, true, 1.0);
	g_hTankHurt = CreateConVar("sm_shop_tank_hurt", "60", "给坦克多少伤害得到1金钱", FCVAR_NOTIFY, true, 1.0);
	g_WitchKilled = CreateConVar("sm_shop_witchkilled", "25", "Giving money for killing a witch", FCVAR_NOTIFY, true, 1.0);
	g_ZombieKilled = CreateConVar("sm_shop_zombiekilled", "0", "Giving money for killing a zombie", FCVAR_NOTIFY, true, 0.0);
	g_hHealTeammate = CreateConVar("sm_shop_heal_teammate", "15", "用医疗包治疗队友给多少钱", FCVAR_NOTIFY, true, 1.0);
	g_hDefiSave = CreateConVar("sm_shop_defi_save", "10", "电击队友复活奖励多少钱", FCVAR_NOTIFY, true, 1.0);
	g_hHelpTeammate = CreateConVar("sm_shop_help_teammate_save", "2", "救下队友的奖励 (除开被舌头吊起来的情况)", FCVAR_NOTIFY, true, 1.0);
	g_hIncapSurvivor = CreateConVar("sm_shop_infected_survivor_incap", "15", "感染者玩家击倒幸存者给多少钱 (除了舌头捆倒幸存者)", FCVAR_NOTIFY, true, 1.0);
	g_hKillSurvivor = CreateConVar("sm_shop_infected_survivor_killed", "20", "感染者玩家击杀幸存者给多少钱", FCVAR_NOTIFY, true, 1.0);
	g_hTKSurvivorEnable = CreateConVar("sm_shop_survivor_TK_enable", "1", "如果为1，友伤扣钱黑，黑1血扣多少钱，如果为0则不扣钱", FCVAR_NOTIFY, true, 0.0, true, 1.0);
	g_hGascanMapOff = CreateConVar("sm_shop_gascan_map_off", "", "这些地图用不能购买油桶, 用逗号分割(无空格). (0=全部的地图, 空格 = 无).", FCVAR_NOTIFY);
	g_hColaMapOff = CreateConVar("sm_shop_cola_map_off", "", "这些地图用不能购买可乐瓶, 用逗号分割(无空格). (0=全部的地图, 空格 = 无).", FCVAR_NOTIFY);
	g_hMaxJumpLimit = CreateConVar("sm_shop_special_max_jump_limit", "5", "特殊物品空中跳跃最大次数", FCVAR_NOTIFY, true, 1.0);
	g_hInfiniteAmmoTime = CreateConVar("sm_shop_special_infinite_ammo_time", "45", "特殊物品无限子弹能持续多久", FCVAR_NOTIFY, true, 1.0);
	g_hStageComplete = CreateConVar("sm_shop_stage_complete", "0", " 小章节结束给生还者多少钱.", FCVAR_NOTIFY, true, 0.0);
	g_hFinalMissionComplete = CreateConVar("sm_shop_final_mission_complete", "0", "救援成功给存活生还者的钱", FCVAR_NOTIFY, true, 0.0);
	g_hWipeOutSurvivor = CreateConVar("sm_shop_final_mission_lost", "0", "团灭生还者扣多少钱以及有感染者玩家灭团生还者给多少钱", FCVAR_NOTIFY, true, 0.0);
	g_hDeadEyeTime = CreateConVar("sm_shop_special_dead_eyes_time", "60", "特殊物品心灵透视能持续多久", FCVAR_NOTIFY, true, 1.0);
	g_hInfectedShopEnable = CreateConVar("sm_shop_infected_enable", "1", "如果为1，则启动感染者购买菜单", FCVAR_NOTIFY, true, 0.0, true, 1.0);
	g_hInfectedShopTime = CreateConVar("sm_shop_infected_wait_time", "1", "感染者玩家必须等到幸存者离开安全区至少多少秒后才能购买物品。(0=感染者的商店随时可用)", FCVAR_NOTIFY, true, 0.0);
	g_hInfectedShopColdDown = CreateConVar("sm_shop_infected_cooltime_block", "3.0", "感染者购买冷却时间(0=无)", FCVAR_NOTIFY, true, 0.0);
	g_hSurvivorShopColdDown = CreateConVar("sm_shop_survivor_cooltime_block", "1.0", "在玩家购买物品后，多长时间才能再次购买（秒）。(0=关闭)。", FCVAR_NOTIFY, true, 0.0);
	g_hImmuneDamageTime = CreateConVar("sm_shop_special_immune_everything_time", "15", "特殊物品伤害免疫能持续多久", FCVAR_NOTIFY, true, 1.0);
	g_hInfectedShopTankLimit = CreateConVar("sm_shop_infected_tank_limit", "2", "场上坦克数量超过多少数量后就不能购买坦克了(0=不能购买坦克)", FCVAR_NOTIFY, true, 0.0);
	g_hInfectedShopWitchLimit = CreateConVar("sm_shop_infected_witch_limit", "1", "场上女巫数量超过多少数量后就不能购买女巫了(0=不能购买女巫)", FCVAR_NOTIFY, true, 0.0);
	g_hWitchSpawnSafetyRange = CreateConVar("sm_shop_infected_witch_spawn_safety_range", "1250", "感染者玩家可以在离幸存者多远的地方购买女巫.", FCVAR_NOTIFY, true, 100.0);
	g_hWitchKillTime = CreateConVar("sm_shop_infected_witch_lifespan", "180", "在多少秒后踢掉女巫(在此插件中只删除玩家购买的女巫)", FCVAR_NOTIFY, true, 1.0);
	g_hFreezeTime = CreateConVar("sm_shop_special_freeze_time", "6", "特殊物品冰冻世界能持续多久", FCVAR_NOTIFY, true, 1.0);
	g_hMaxMoney = CreateConVar("sm_shop_max_moeny_limit", "99999", "最大可持有金钱数量(当服务器换图或者玩家离开服务器才能保存金钱到数据库)", FCVAR_NOTIFY, true, 1.0);
	g_hNotifyKillInfectedType = CreateConVar("sm_shop_kill_infected_announce_type", "2", "改变击杀敌人给予金钱信息的显示方式(0: 不显示, 1:在聊天框中, 2: 在提示框中, 3: 在屏幕中心？)", FCVAR_NOTIFY, true, 0.0, true, 3.0);
