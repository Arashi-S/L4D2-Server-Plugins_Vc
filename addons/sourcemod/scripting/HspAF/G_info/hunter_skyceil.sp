...
public void OnPluginStart()
{
	...
	g_hHSCResetInv = CreateConVar("hsc_reset_interval", "2.0", "重置起飞次数的时钟间隔", FCVAR_NONE, true, 0.0);
	g_hHSCLimit = CreateConVar("hsc_limit", "2", "允许HT弹天花板的数量，0=不限制", FCVAR_NONE, true, 0.0, true, 32.0);
