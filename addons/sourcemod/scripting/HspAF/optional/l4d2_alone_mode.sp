...
public void OnPluginStart()
{
	...
	g_cvPinnedDmg[SMOKER] = CreateConVar("l4d2_alone_damage_smoker", "10.0");
	g_cvPinnedDmg[HUNTER] = CreateConVar("l4d2_alone_damage_hunter", "10.0");
	g_cvPinnedDmg[JOCKEY] = CreateConVar("l4d2_alone_damage_jockey", "10.0");
	g_cvPinnedDmg[CHARGER] = CreateConVar("l4d2_alone_damage_charger", "10.0");
